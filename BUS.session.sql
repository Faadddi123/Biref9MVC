...
('08:00:00', '12:00:00', 50.00, '2024-01-01', 1),
('14:00:00', '17:30:00', 40.00, '2024-01-02', 2);
...
INSERT INTO Company (id, name, image) VALUES
(1, 'CTM', 'ctm_logo.png'),
(2, 'Sahara Voyages', 'sahara_voyages_logo.png'),
(3, 'Atlas Express', 'atlas_express_logo.png'),
(4, 'Marrakech Tours', 'marrakech_tours_logo.jpeg'),
(5, 'Moroccan Explorer', 'moroccan_explorer_logo.png'),
(6, 'Maghreb Adventures', 'maghreb_adventures_logo.png'),
(7, 'Golden Dunes Tours', 'golden_dunes_tours_logo.png'),
(8, 'Casablanca Shuttles', 'casablanca_shuttles_logo.png'),
(9, 'Rif Explorers', 'rif_explorers_logo.png'),
(10, 'Atlas Trekking', 'atlas_trekking_logo.png');
-- @block

-- @block
UPDATE Company
SET image = CASE
    WHEN id = 1 THEN 'ctm_logo.png'
    WHEN id = 2 THEN 'sahara_voyages_logo.png'
    WHEN id = 3 THEN 'atlas_express_logo.png'
    WHEN id = 4 THEN 'marrakech_tours_logo.jpg'
    WHEN id = 5 THEN 'moroccan_explorer_logo.png'
    WHEN id = 6 THEN 'maghreb_adventures_logo.png'
    WHEN id = 7 THEN 'golden_dunes_tours_logo.png'
    WHEN id = 8 THEN 'casablanca_shuttles_logo.png'
    WHEN id = 9 THEN 'rif_explorers_logo.png'
    WHEN id = 10 THEN 'atlas_trekking_logo.png'
    ELSE image
END;
-- @block
-- Insert into City table
...
('08:00:00', '12:00:00', 50.00, '2024-01-01', 1),
('14:00:00', '17:30:00', 40.00, '2024-01-02', 2),
('09:30:00', '11:45:00', 35.00, '2024-01-03', 3),
('12:00:00', '15:15:00', 55.00, '2024-01-04', 4),
('10:45:00', '13:30:00', 45.00, '2024-01-05', 5),
('16:00:00', '18:45:00', 60.00, '2024-01-06', 6),
('11:30:00', '14:00:00', 40.00, '2024-01-07', 7),
('13:45:00', '16:30:00', 52.00, '2024-01-08', 8),
('15:15:00', '17:45:00', 48.00, '2024-01-09', 9),
('18:00:00', '21:30:00', 65.00, '2024-01-10', 10),
('07:45:00', '10:15:00', 38.00, '2024-01-11', 11),
('12:30:00', '14:45:00', 42.00, '2024-01-12', 12),
('14:30:00', '17:00:00', 55.00, '2024-01-13', 13),
('09:00:00', '11:30:00', 30.00, '2024-01-14', 14),
('16:45:00', '19:15:00', 48.00, '2024-01-15', 15),
('10:30:00', '13:00:00', 40.00, '2024-01-16', 16),
('13:15:00', '15:45:00', 50.00, '2024-01-17', 17),
('15:45:00', '18:30:00', 42.00, '2024-01-18', 18),
('17:30:00', '20:00:00', 58.00, '2024-01-19', 19),
('08:45:00', '11:15:00', 35.00, '2024-01-20', 20);
